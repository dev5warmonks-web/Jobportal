...
export default function EducationForm({ editItem, setEditItem, reload }) {
  ...
  useEffect(() => {
    if (editItem) {
      ...
      setForm({ education: "", is_active: true });
    }
  }, [editItem]);
  ...
  const handleSubmit = async (e) => {
    ...
    const url = editItem
      ? `${BASE_URL}/api/education/${editItem._id}`
    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1">
          <label className="block mb-1 font-medium text-black">Highest Education</label>
          <input
            type="text"
            name="education"
